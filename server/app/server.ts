...
export class Server {
    ...
    constructor(
        @inject(TYPES.Application) private application: Application, // @inject(TYPES.DatabaseService) private databaseService: DatabaseService,
    ) {}
    ...
    // TODO: ask if im supposed to make the connection in the app instead of the database
